...
public class Experimento implements Task {
    ...
    public Experimento(String nombre,String apellido,String email,String edad,String salario,String departamento){
        //CREAR VARIABLE
        this.nombre=nombre;
    ...
    public static Experimento ElementsTest(String nombre, String apellido, String email,String edad, String salario, String departamento) {
        return instrumented(Experimento.class,nombre,apellido,email,edad,salario,departamento);
    }
